<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				...
				<div id="checkin" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<?php if ($this->m_permission->isHavePermission('checkin', 3)) {?>
						<a class="collapse-item" href="/checkin/offdaywork">薪資</a>
						<?php } ?>
					</div>
				</div>
			</li>
			...
			<?php if ($this->m_permission->isHavePermission('admin', 2)) {?>
			<li class="nav-item">
		...
		<?php
		if ($this->m_permission->isHavePermission('ordernum', 2) ||
				$this->m_permission->isHavePermission('orderscan', 2)
			) {
		}
				?>